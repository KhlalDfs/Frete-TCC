<?php
   ...
   if($resultEdit->num_rows > 0){
    ...
    if($tipo == "A"){
        $result_users = "SELECT * from etiqueta";
        ...
        $nump = ceil($total/$qtd);
        $inicio = ($qtd*$pgn)-$qtd;
        $rest = "SELECT * from etiqueta limit $inicio, $qtd";
        $result = mysqli_query($conn, $rest);
        $ver = mysqli_num_rows($result);
    }
        else{
        $result = "SELECT * from etiqueta where idUser = $id";
                            ...
                            <table class="table" style="width: 90%;">  
                                ...
                                <tbody style="font-size: 13px;">
                                    ...
                                    <?php while($rows_users = mysqli_fetch_assoc($view)){?>
                                            <td><?php echo $rows_users['idEt'];?></td>
                                            <td><?php echo $rows_users['nome'];?></td>
                                            <td><?php echo $rows_users['nomeDestinatario'];?></td>
                                            ...
                                            <?php  echo "<td><a href='pressEt.php?id=$rows_users[idEt]' style='color: green'>"?><i class="fa-solid fa-file-pdf"></a></td>
                                           <?php  echo "<td><a href='deleteEt.php?id=$rows_users[idEt]' style='color: red'>"?><i class="fa-solid fa-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
