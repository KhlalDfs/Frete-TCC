...
if(isset($_POST['salvar'])){
        ...
        $save = mysqli_query($conn, "INSERT INTO transportadora (nome, valor, descricao, idUser, cnpj, enderecoDestino) 
        values ('{$nome}', '{$valor}', '{$descricao}', '{$idUser}', '{$cnpj}', '{$endereco}')");
        
        if($save){
            echo "CTe salva com sucesso";
            ...
            <section class="area-cadastro">
                <div class="cadastro">
                    <form method="POST" action="">
                        ...
                        <input type="text" name="enderecoDestino" placeholder="Endereco de Destino Final" value="<?php echo $endereco ?>">></br>
