<?php
   ...
   if($resultEdit->num_rows > 0){
    ...
    if($tipo == "A"){
        ...
        $nump = ceil($total/$qtd);
        $inicio = ($qtd*$pgn)-$qtd;
        $rest = "SELECT * from cotacao, usuario limit $inicio, $qtd";
        $result = mysqli_query($conn, $rest);
        $ver = mysqli_num_rows($result);
    }
        else{
        $result = "SELECT * from cotacao where idUser = $id";
        ...
        $nump = ceil($total/$qtd);
        $inicio = ($qtd*$pgn)-$qtd;
        $rest = "SELECT * from cotacao limit $inicio, $qtd";
        $result = mysqli_query($conn, $rest);
        $ver = mysqli_num_rows($result);
    }
                        ...
                        <div >
                            <table class="table" style="width: 90%;">   
                                ...
                                <?php 
                                     ...
                                     while($rows_users = mysqli_fetch_assoc($view)){?>
                                        <tr>
                                            ...
                                            <?php  echo "<td><a href='novoPedido.php?id=$rows_users[idCot]'>"?><i class="fa-solid fa-clipboard-check"></i></a></td>
