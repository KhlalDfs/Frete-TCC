        ...
        <div class="conteudo">
            ...
            <div class="table">
                <div class="container theme-showcase" role="main">
                    <div class="page-header"><h3>Usuários</h3></div>
                    <div class="row">
                        <div >
                            <table class="table" style="width: 90%;">   
                                ...
                                <tbody style="font-size: 13px;">
                                    <?php while($rows_users = mysqli_fetch_assoc($view)){?>
                                        <tr>
                                            <td><?php echo $rows_users['idCot'];?></td>
                                            ...
                                            ?></td>
                                            <td><?php echo $rows_users['comprimento']." cm";?></td>
                                            <td><?php echo $rows_users['altura']." cm";?></td>
                                            <td><?php echo $rows_users['largura']." cm";?></td>
                                            <td><?php echo "R$ ".$rows_users['valor'];?></td>
                                            <td><?php echo "R$ ".$rows_users['frete'];?></td> 
                                            <?php  echo "<td><a href='newSale.php?id=$rows_users[idCot]'>"?><i class="fa-solid fa-clipboard-check"></i></a></td>
                                            <?php  echo "<td><a href='deletePed.php?id=$rows_users[idCot]' style='color: red'>"?><i class="fa-solid fa-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
