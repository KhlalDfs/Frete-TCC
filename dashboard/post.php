...
if(isset($_POST['salvar'])){
    ...
    $nomeD = $_POST['nomeDes'];
    $save = mysqli_query($conn, "INSERT INTO postagem (nome, cepOrigem, cepDestino, peso, valor, comprimento, altura, largura, tipoFrete, idUser, frete, prazo, descricao, nomeDestinatario) 
    values ('{$nome}', '{$cepOrigem}', '{$cepDestino}', '{$peso}', '{$valor}', '{$comprimento}', '{$altura}', '{$largura}', '{$tipoFrete}', '{$idUser}', '{$frete}', '{$prazo}', '{$descricao}', '{$nomeD}')");
    $executar = mysqli_query($conn, $save);
    if($save){
        echo "Postagem concluída com sucesso";
    ...
    <div class="sidebar">
        ...
        <div class="content">
            <div class="titulo-secao">
                <h2>Realizar Postagem para os Correios </h2>
                <br/>
            ...
            <section class="area-cadastro">
                <div class="cadastro">
                    ...
                    <h6 style="color: white;">Nome do Cliente</h6>
                        ...
                        <h6 style="color: white;">Nome do Destinatário</h6>
                        <input type="text" name="nomeDes" placeholder="Nome do Destinatário"></br>
