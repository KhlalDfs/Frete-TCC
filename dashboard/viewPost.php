<?php
   ...
   if($resultEdit->num_rows > 0){
    ...
    if($tipo == "A"){
        $result_users = "SELECT * from postagem";
        ...
        $nump = ceil($total/$qtd);
        $inicio = ($qtd*$pgn)-$qtd;
        $rest = "SELECT * from postagem limit $inicio, $qtd";
        $result = mysqli_query($conn, $rest);
        $ver = mysqli_num_rows($result);
    }
        else{
        $result = "SELECT * from postagem where idUser = $id";
                            ...
                            <table class="table" style="width: 90%;">  
                                ...
                                <tbody style="font-size: 13px;">
                                    ...
                                    <?php while($rows_users = mysqli_fetch_assoc($view)){?>
                                            <td><?php echo $rows_users['idPost'];?></td>
                                            ...
                                            <td><?php echo $rows_users['descricao'];?></td>
                                             <?php  echo "<td><a href='deletePost.php?id=$rows_users[idPost]' style='color: red'>"?><i class="fa-solid fa-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
