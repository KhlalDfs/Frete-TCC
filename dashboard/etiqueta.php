...
if(isset($_POST['salvar'])){
    ...
    $nomeD = $_POST['nomeDes'];
    $save = mysqli_query($conn, "INSERT INTO etiqueta (nome, cepOrigem, cepDestino, peso, valor, comprimento, altura, largura, tipoFrete, idUser, frete, prazo, descricao, nomeDestinatario) 
    ...
    if($save){
        echo "Etiqueta salva com sucesso";
