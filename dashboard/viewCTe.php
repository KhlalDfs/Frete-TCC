<?php
   ...
   if($resultEdit->num_rows > 0){
    ...
    if($tipo == "A"){
        $result_users = "SELECT * from transportadora";
        ...
        $nump = ceil($total/$qtd);
        $inicio = ($qtd*$pgn)-$qtd;
        $rest = "SELECT * from transportadora limit $inicio, $qtd";
        $result = mysqli_query($conn, $rest);
        $ver = mysqli_num_rows($result);
    }
        else{
        $result = "SELECT * from transportadora where idUser = $id";
    ...
    <section class="principal">
        ...
        <div class="conteudo">
            <div class="titulo-secao">
                <h2>Conhecimento de Transporte Eletronico</h2>
                <br/>
                            ...
                            <table class="table" style="width: 90%;">  
                                ...
                                <tbody style="font-size: 13px;">
                                    ...
                                    <?php while($rows_users = mysqli_fetch_assoc($view)){?>
                                            <td><?php echo $rows_users['idCTe'];?></td>
                                            <td><?php echo $rows_users['nome'];?></td>
                                            <td><?php echo $rows_users['valor'];?></td>
                                            <td><?php echo $rows_users['cnpj'];?></td>
                                            <td><?php echo $rows_users['enderecoDestino'];?></td>
                                            <td><?php echo $rows_users['descricao'];?></td>
                                            <?php  echo "<td><a href='pressCTe.php?id=$rows_users[idCTe]'>"?><i class="fa-solid fa-file-pdf"></i></a></td>
                                            <?php  echo "<td><a href='deleteCTe.php?id=$rows_users[idCTe]' style='color: red'>"?><i class="fa-solid fa-trash"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
