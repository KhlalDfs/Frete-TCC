        ...
        <div class="content">
            ...
            <div class="box-info">
                <div style="background:linear-gradient(45deg, #3f4866, #879ad8);" class="box-info-single">
                    <div class="info-text">
                        <a href="#"><p>Realizar Cotação</p></a>
                    </div>
                    <a href="calcular.php" style="color: white;"><i class="fa-solid fa-truck-fast"></i></a>
                </div>
            </div>
            <div class="box-info">
                <div style="background:linear-gradient(45deg, #3f4866, #879ad8);" class="box-info-single">
                    <div class="info-text">
                        <a href="view.php"><p>Visualizar Cotações Salvas</p></a>
                    </div>
                    <a href="viewCot.php" style="color: white;"><i class="fa-solid fa-eye"></i></a>
                </div>
            </div>
    </section>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.0/js/all.min.js"></script>
